...
namespace RegistaShop.WebUI.Services.CatalogServices.ProductServices
{
	public class ProductService : IProductService
	{
		...
		public ProductService(HttpClient httpClient, ICategoryService categoryService)
		{
		...
		public async Task<List<ResultProductWithCategoryDto>> GetProductsWithByCategoryIdAsync(string categoryId)
		{
