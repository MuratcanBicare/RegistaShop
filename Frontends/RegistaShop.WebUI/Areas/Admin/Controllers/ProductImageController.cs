...
namespace RegistaShop.WebUI.Areas.Admin.Controllers
{
	...
	public class ProductImageController : Controller
	{
		...
		public async Task<IActionResult> ProductImageDetail(string id)
		{
			...
			ViewBag.v2 = "Ürünler";
			ViewBag.v3 = "Ürüne Ait Görselleri Güncelleme Sayfası";
			ViewBag.v0 = "Ürün Ait Görsel İşlemleri";
		...
		public async Task<IActionResult> ProductImageDetail(UpdateProductImageDto updateProductImageDto)
		{
			...
			var responseMessage = await client.PutAsync("https://localhost:7245/api/ProductImages/", stringContent);
			if (responseMessage.IsSuccessStatusCode)
			{
